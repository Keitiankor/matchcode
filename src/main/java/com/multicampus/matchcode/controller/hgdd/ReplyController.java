...
public class ReplyController {
    ...
    public String replyInsert(@PathVariable Long id, ReplyRequest request, Model model, @SessionAttribute(name = SessionConstant.MEMBER_DTO, required = false) MemberDTO memberDTO) {
        if (memberDTO != null) {
    ...
    public String deleteReply(@PathVariable Long id, Model model, @PathVariable Long postId, @SessionAttribute(name = SessionConstant.MEMBER_DTO, required = false) MemberDTO memberDTO) {
